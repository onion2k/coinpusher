...
export const TOP_PUSHER_HEIGHT = PLATFORM_TOP_HEIGHT
...
export const COIN_SPAWN_Z =
  TOP_PUSHER_OFFSET_Z + TOP_PUSHER_DEPTH / 2 + 0.1

export const BOTTOM_PUSHER_HEIGHT = PLATFORM_BOTTOM_HEIGHT + 0.25
export const BOTTOM_PUSHER_DEPTH = 0.4
export const BOTTOM_PUSHER_VERTICAL_SIZE = 1.0
